...
const locations = [ //array
    { //object in array
        ...
        text:"You're in town square. You see a sign that says \"store\"." //scaping 
    },
    {
        name: "store",
    ...
    },
    {
        ...
        "button text": ["REPLAY?","REPLAY?","REPLAY?"],
        "button functions":[restart,restart,restart],
        text:"You defeat drago. You win the game! " 
    },
    {
        name: "easter egg",
...
function buyHealth(){
    ...
    if(gold >= 10){
        gold = gold - 10; //compound assignment
        health += 10; //shorthand
        goldText.innerText = gold;
        healthText.innerText = health;
    }else{
        text.innerText = "you dont have enough gold to but health";
    }
...
function attack(){
    ...
    //math.floor round than value to the nearest whole num
    monsterHealth -= weapons[currentWeapon].power + Math.floor(Math.random() * xp) + 1; //math.random randomizes 0 or 1
    healthText.innerText = health;
    monsterHealthText.innerText = monsterHealth;
    if(health <= 0){
        lose();
